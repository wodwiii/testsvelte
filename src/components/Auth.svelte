...
<div class="flex flex-col items-center">
	<div class="text-lg">{register ? 'Register' : 'Login'}</div>
	<div class="flex flex-col gap-y-4 mt-4 items-center">
		...
		<button
			...
			class="border-solid border-2 border-gray-400 text-sm font-bold py-2 px-4 rounded-lg hover:border-black"
		>
